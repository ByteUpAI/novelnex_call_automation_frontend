...
function VoiceAgent({ onNavigateToChat }) {
  ...
  const startCall = async () => {
    ...
    try {
      const response = await fetch(
        "https://nxsolutions.app.n8n.cloud/webhook/api/create-web-call/",
        {
          method: "POST",
        }
      );
    ...
    <div className="agent-card">
      ...
      <div className="agent-content">
        ...
        <div className="status">
          <span
            className={`status-indicator ${isProcessing ? "processing" : ""}`}
          ></span>
        ...
        <div className="action-buttons">
          ...
          <button className="chat-btn" onClick={onNavigateToChat}>
